            ...
            <div class="card-header">
                <div class="w-100 justify-content-between d-flex flex-wrap align-items-center gap-1">
                    ...
                    <div class="d-flex align-items-center gap-1">
                        ...
                        <a class="btn buttons-collection action-item btn-primary ms-3" href="{{ route('export.withdrawal.index') }}">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th title="Vendor" class="text-start column-key-1 sorting" tabindex="0"
                                        ...
                                        {{ trans('core/base::layouts.customer') }}
                                    </th>
                                    ...
                                    <th title="Fee" class="column-key-3 sorting" tabindex="0"
                                        ...
                                        {{ trans('core/base::layouts.balance') }}
                                    </th>
                                ...
                                @foreach ($customerWithdrawals as $customerWithdrawal)
                                    <tr class="odd">
                                        ...
                                        <td class="text-center no-column-visibility column-key-0 sorting_1">
                                            {{ $customerWithdrawal->id }}</td>
                                        <td class="  text-start  column-key-1">
                                            <a href="customers/edit/8">
                                                {{ $customerWithdrawal->customer->name ?? '[Không có khách]' }}

                                            </a>
                                        </td>
                                        <td class="   column-key-2">{{ format_price($customerWithdrawal->amount) }}</td>
                                        <td class="   column-key-3">
                                            {{ format_price($customerWithdrawal->customer->walet_1) }}</td>
                                        <td class="  text-nowrap column-key-4">
                                            {{ date_format($customerWithdrawal->created_at, 'H:i d-m-Y') }}</td>
                                        <td class="  text-center  column-key-5">
                                            ...
                                            <span
                                                class="badge {{ $statusClasses[$customerWithdrawal->status] ?? 'bg-secondary text-secondary-fg' }}">
                                                {{ trans('core/base::layouts.' . $customerWithdrawal->status) }}
                                            </span>
                                        </td>
                                        <td class="  text-center no-column-visibility text-nowrap">
                                            <div class="table-actions">
                                                <a href="{{ route('withdrawals-manager.edit', $customerWithdrawal->id) }}"
                                                ...
                                                <button class="btn btn-sm btn-icon btn-danger" data-bs-toggle="modal"
                                                    data-bs-target="#deleteCustomerWithdrawal_{{ $customerWithdrawal->id }}">
