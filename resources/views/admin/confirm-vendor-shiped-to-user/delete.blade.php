<form action="{{ route('withdrawals-manager.destroy', $customerWithdrawal->id) }}" method="POST" style="display:inline;">
    @csrf
    @method('DELETE')
<div class="modal fade" id="deleteCustomerWithdrawal_{{$customerWithdrawal->id}}" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
