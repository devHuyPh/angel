  ...
  <div class="container py-4">
    ...
    <div class="col-md-6 col-lg-4">
      ...
      <div style="
          ...
          gap: 8px;
          ">
      <a href="{{ route('cards.edit', $card->id) }}" class="btn btn-sm" style="
            padding: 4px 8px;
            font-size: 12px;
          ...
          " onmouseover="this.style.backgroundColor='rgba(255, 193, 7, 0.2)'"
      onmouseout="this.style.backgroundColor='transparent'">
      {{ __('core/base::layouts.edit_button') }}
      </a>

      <form action="{{ route('cards.destroy', $card->id) }}" method="POST"
      onsubmit="return confirm('{{ __('core/base::layouts.delete_confirm') }}');" style="display:inline;">
      @csrf
      @method('DELETE')
      <button type="submit" class="btn btn-sm" style="
            ...
            color: #dc3545;
            transition: background-color 0.3s ease;
            " onmouseover="this.style.backgroundColor='rgba(220, 53, 69, 0.2)'"
        onmouseout="this.style.backgroundColor='transparent'">
        {{ __('core/base::layouts.delete_button') }}
      </button>
      </form>
      </div>
      ...
      <div class="card-number" style="font-size: 24px; font-weight: 700; letter-spacing: 3px; margin: 20px 0;">
      {{ $card->number }}
      </div>
