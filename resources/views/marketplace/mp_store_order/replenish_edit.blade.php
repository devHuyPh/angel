...
@section('content')
    ...
    <div class="main-form">
      ...
      {{trans('core/base::kho.restock_orders_need_delivery')}} #{{ $storeOrder->transaction_code }} - {{ format_price($storeOrder->amount) }}
      </strong>
      </div>
      ...
      <form method="POST"
      action="{{ route('marketplace.replenish-orders.buupdate', $storeOrder->transaction_code) }}"
      ...
      <div class="form-group mb-3" id="completed-image-group" style="display: none;">
        ...
        <input type="file" name="completed_image" class="form-control" accept="image/*">
