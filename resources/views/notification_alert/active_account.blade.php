...
<!-- @if (!$customer->is_active_account)
    <div class="container col-12  mb-md-0 text-md-start mx-20 notification_active_account">
                    ...
                    <div class="d-flex align-items-center gap-alert-error">
                        ...
                        <div class="w-100">
                            <h4 class="alert-title text-danger mb-0">
                                {{ trans('core/base::layouts.account-activation-instruction') }} <a
                                    class="text-success fw-bold" href="/products">Mua ngay</a>
                            </h4>
                        </div>
                    </div>
                </div>
