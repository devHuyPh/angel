...
class MarketplaceServiceProvider extends ServiceProvider
{
  ...
  public function boot(): void
  {
    ...
    if (defined('LANGUAGE_MODULE_SCREEN_NAME') && defined('LANGUAGE_ADVANCED_MODULE_SCREEN_NAME')) {
      LanguageAdvancedManager::registerModule(Store::class, ['name', 'description', 'content', 'address', 'company', 'cover_image']);
    }
    ...
    DashboardMenu::beforeRetrieving(function (): void {
      DashboardMenu::make()
        ...
        ->when(MarketplaceHelper::getSetting('verify_vendor', 1), function (DashboardMenuSupport $dashboardMenu): void {
    ...
    DashboardMenu::for('vendor')->beforeRetrieving(function (): void {
      DashboardMenu::make()
        ...
        // order-to-user
        ->registerItem([
          'id' => 'marketplace.shipped-to-user',
          'priority' => 3,
          'name' => __('Shipped to user'),
          'url' => fn() => route('marketplace.shipped-to-user.index'),
          'icon' => 'ti ti-shopping-cart',
        ])
        //mpmanager
        // ->registerItem([
        //   'id' => 'marketplace.vendor.store-manager',
        //   'priority' => 3,
        //   'name' => __('Store Manager'),
        //   'url' => fn() => route('marketplace.vendor.store-manager.index'),
        //   'icon' => 'ti ti-building-warehouse',
        // ])
        //mpmanagerend
        //mpstoreorder
        ->registerItem([
          'id' => 'marketplace.vendor.store-orders',
          'priority' => 3,
          'name' => __('Store orders'),
          'url' => fn() => route('marketplace.vendor.store-orders.index'),
        ...
        ->registerItem([
          'id' => 'marketplace.vendor.notifications',
          'priority' => 7,
          'name' => __('Notification'),
          'url' => fn() => route('marketplace.vendor.notification'),
          'icon' => 'ti ti-bell',
        ])
        ->registerItem([
    ...
    DashboardMenu::for('customer')->beforeRetrieving(function (): void {
      DashboardMenu::make()->when(
        auth('customer')->user()->is_vendor,
        function () {
          return DashboardMenu::make()->registerItem([
            'id' => 'marketplace.vendor.dashboard',
            'priority' => 990,
        ...
        function (): void {
          DashboardMenu::make()->when(MarketplaceHelper::isVendorRegistrationEnabled() && !MarketplaceHelper::getSetting('hide_become_vendor_menu_in_customer_dashboard', false), function () {
            return DashboardMenu::make()->registerItem([
    ...
    //o day
    DashboardMenu::for('bitsgold')->beforeRetrieving(function (): void {
      DashboardMenu::make()
        ->registerItem([
          'id' => 'bitsgold.dashboard',
          'priority' => 1,
          'name' => __('Dashboard'),
          'url' => fn() => route('bitsgold.dashboard'),
          'icon' => 'ti ti-home',
        ])
        ->registerItem([
          'id' => 'bitsgold.plan',
          'priority' => 2,
          'name' => __('Product'),
          'url' => fn() => route('bitsgold.plan'),
          'icon' => 'ti ti-package',
        ])
        // ->registerItem([
        //   'id' => 'bitsgold.invest_history',
        //   'priority' => 3,
        //   'name' => __('Invest History'),
        //   'url' => fn() => route('bitsgold.invest_history'),
        //   'icon' => 'ti ti-calendar',
        // ])
        // ->registerItem([
        //   'id' => 'bitsgold.add_fund',
        //   'priority' => 4,
        //   'name' => __('Add Fund'),
        //   'url' => fn() => route('bitsgold.add_fund'),
        //   'icon' => 'ti ti-credit-card',
        // ])
        // ->registerItem([
        //   'id' => 'bitsgold.transaction',
        //   'priority' => 5,
        //   'name' => __('Transaction'),
        //   'url' => fn() => route('bitsgold.transaction'),
        //   'icon' => 'ti ti-gift',
        // ])
        ->registerItem([
          'id' => 'bitsgold.referral',
          'priority' => 3,
          'name' => __('plugins/marketplace::marketplace.referral'),
          'url' => fn() => route('bitsgold.referral'),
          'icon' => 'ti ti-package',
        ])
        ->registerItem([
          'id' => 'bitsgold.manager',
          'priority' => 4,
          'name' => __('plugins/marketplace::marketplace.manager'),
          'url' => fn() => route('maketing.manager.index'),
          'icon' => 'ti ti-map-pin',
        ])
        ->registerItem([
          'id' => 'bitsgold.withdraw',
          'priority' => 4,
          'name' => __('plugins/marketplace::marketplace.KYC'),
          'url' => fn() => route('kyc.index'),
          'icon' => 'ti ti-brand-ycombinator',
        ])
        //  ->registerItem([
        //   'id' => 'bitsgold.referral_bonus',
        //   'priority' => 5,
        //   'name' => __('plugins/marketplace::marketplace.referral_bonus'),
        //   'url' => fn() => route('reward.customer'),
        //   'icon' => 'ti ti-gift',
        // ])
        ->registerItem([
          'id' => 'client.dashboard',
          'priority' => 6,
          'name' => __('plugins/marketplace::marketplace.report'),
          'url' => fn() => route('client.dashboard'),
          'icon' => 'ti ti-file-excel',
        ])
        ->registerItem([
          'id' => 'client.bank_account',
          'priority' => 8,
          'name' => __('plugins/marketplace::marketplace.bank_account'),
          'url' => fn() => route('bank_accounts.index'),
          'icon' => 'ti ti-building-bank', //<i class="ti ti-building-bank"></i>
        ])
        ->registerItem([
          'id' => 'client.withdrawal_user',
          'priority' => 7,
          'name' => __('plugins/marketplace::marketplace.withdrawals'),
          'url' => fn() => route('withdrawals.index'),
          'icon' => 'ti ti-folder-dollar', //<i class="ti ti-moneybag-plus"></i><i class="ti ti-folder-dollar"></i>
        ]);
      // ->registerItem([
      //   'id' => 'client.deposit-user',
      //   'priority' => 7,
      //   'name' => __('plugins/marketplace::marketplace.deposit'),
      //   'url' => fn() => route('deposit.index'),
      //   'icon' => 'ti ti-report-money', //<i class="ti ti-report-money"></i>
      // ])
    });
    ...
    $this->app['events']->listen(RouteMatched::class, function (): void {
      if (!MarketplaceHelper::getSetting('verify_vendor', 1)) {
        config([
          'plugins.marketplace.email.templates' => Arr::except(config('plugins.marketplace.email.templates'), 'verify_vendor'),
        ]);
      }
    ...
    PanelSectionManager::beforeRendering(function (): void {
      PanelSectionManager::default()->registerItem(SettingEcommercePanelSection::class, fn() => PanelSectionItem::make('settings.ecommerce.marketplace')->setTitle(trans('plugins/ecommerce::setting.marketplace.name'))->withIcon('ti ti-building-store')->withDescription(trans('plugins/ecommerce::setting.marketplace.description'))->withPriority(150)->withRoute('marketplace.settings'));
    });
    ...
    $this->app['events']->listen('eloquent.deleted: ' . Customer::class, function (Customer $customer): void {
      ...
      SpecificationGroup::query()->where('author_type', Customer::class)->where('author_id', $customer->getKey())->delete();

      SpecificationAttribute::query()->where('author_type', Customer::class)->where('author_id', $customer->getKey())->delete();

      SpecificationTable::query()->where('author_type', Customer::class)->where('author_id', $customer->getKey())->delete();
    });
    ...
    $this->app->booted(function (): void {
      ...
      $emailTemplates = ['plugins.ecommerce.email.templates.customer_new_order.variables', 'plugins.ecommerce.email.templates.admin_new_order.variables', 'plugins.ecommerce.email.templates.customer_cancel_order.variables', 'plugins.ecommerce.email.templates.order_confirm.variables', 'plugins.ecommerce.email.templates.order_confirm_payment.variables', 'plugins.ecommerce.email.templates.order_recover.variables', 'plugins.ecommerce.email.templates.order-return-request.variables', 'plugins.ecommerce.email.templates.invoice-payment-created.variables', 'plugins.ecommerce.email.templates.review_products.variables', 'plugins.ecommerce.email.templates.download_digital_products.variables'];

      if (!EcommerceHelper::isDisabledPhysicalProduct()) {
        $emailTemplates = [...$emailTemplates, 'plugins.ecommerce.email.templates.customer_delivery_order.variables', 'plugins.ecommerce.email.templates.customer_order_delivered.variables'];
      }
    ...
    Form::component('customEditor', MarketplaceHelper::viewPath('vendor-dashboard.forms.partials.custom-editor'), ['name', 'value' => null, 'attributes' => []]);

    Form::component('customImage', MarketplaceHelper::viewPath('vendor-dashboard.forms.partials.custom-image'), ['name', 'value' => null, 'attributes' => []]);

    Form::component('customImages', MarketplaceHelper::viewPath('vendor-dashboard.forms.partials.custom-images'), ['name', 'values' => null, 'attributes' => []]);
  }
