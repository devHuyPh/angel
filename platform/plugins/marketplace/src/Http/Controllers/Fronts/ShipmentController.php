...
use Botble\Ecommerce\Services\WarehouseReferralService;

class ShipmentController extends BaseController
{
      public function __construct(protected WarehouseReferralService $WarehouseReferral)
    {
    ...
    public function postUpdateStatus(int|string $id, UpdateShippingStatusRequest $request)
    {
        ...
        switch ($shipment->status) {
            case ShippingStatusEnum::DELIVERED:
                ...
                $checkWareHouseReferral = WareHouseReferral::where('order_id',$shipment->order_id)->exists();
                if(!$checkWareHouseReferral){
                    $this->WarehouseReferral->warehouseReferral($shipment->order_id);
                }
                break;
