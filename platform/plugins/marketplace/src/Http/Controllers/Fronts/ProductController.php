...
class ProductController extends BaseController
{
  ...
  public function edit(int|string $id)
  {
    ...
    Assets::addStylesDirectly('vendor/core/plugins/marketplace/css/custom-css.css');
    Assets::addScriptsDirectly('vendor/core/plugins/marketplace/js/readonly-product.js');
    
    return ProductForm::createFromModel($product)
      ->renderForm();
  }
