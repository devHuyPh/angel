...
return [
    ...
    'wallet_refund_detail_title' => 'Wallet payment details',
    'wallet_refund_detail_description' => 'Wallet deducted: :used. Maximum refundable to wallet: :refundable.',
    'wallet_refund_detail_remaining_transfer' => 'Need to refund :remaining via bank transfer if refunding the entire order.',
    'wallet_refund_detail_no_transfer' => 'No additional bank transfer needed.',
    'wallet_refund_max_amount_note' => 'Max refund to wallet: :wallet_refundable. The rest must go back through the original method.',
    'wallet_refund_hint_over_limit' => 'If you enter more than :wallet_refundable, the wallet portion will still be refunded while the rest needs to be handled outside.',
    'products' => 'product(s)',
    'default' => 'Default',
    'system' => 'System',
    ...
    'refund_and_cancel_order_reason' => 'Refund and cancel order',
    'refund_and_cancel_order_description' => 'Order was canceled after refunding the full amount of :amount.',
    'refund_and_cancel_button' => 'Refund to wallet & Cancel order',
