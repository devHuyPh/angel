...
<div class="row price-group">
    ...
    <div class="col-md-4">
        <x-core::form.text-input :label="trans('plugins/ecommerce::products.form.price')" name="price"
          :data-thousands-separator="EcommerceHelper::getThousandSeparatorForInputMask()"
          :data-decimal-separator="EcommerceHelper::getDecimalSeparatorForInputMask()" :value="old('price', $product ? $product->price : $originalProduct->price ?? 0)" step="any" class="input-mask-number js-product-price"
          :group-flat="true">
          <x-slot:prepend>
    ...
    <div class="col-md-6">
        <x-core::form.text-input :label="trans('plugins/ecommerce::products.form.warehouse_price')" name="warehouse_price"
          class="input-mask-number js-warehouse-price"
          :data-thousands-separator="EcommerceHelper::getThousandSeparatorForInputMask()"
          :data-decimal-separator="EcommerceHelper::getDecimalSeparatorForInputMask()"
          :data-warehouse-percent-text="trans('plugins/ecommerce::products.form.warehouse_price_percent_helper')"
          :value="old('warehouse_price', $product ? $product->warehouse_price : ($originalProduct->warehouse_price ?? null))"
          :placeholder="trans('plugins/ecommerce::products.form.warehouse_price_placeholder')" step="any" :group-flat="true">
          <x-slot:prepend>
            <span class="input-group-text">{{ get_application_currency()->symbol }}</span>
          </x-slot:prepend>
          <x-slot:helper-text>
            <div>{{ trans('plugins/ecommerce::products.form.warehouse_price_helper') }}</div>
          </x-slot:helper-text>
        </x-core::form.text-input>
