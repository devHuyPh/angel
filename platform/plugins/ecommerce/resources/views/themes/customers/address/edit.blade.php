...
@section('content')
    ...
    <div class="header d-flex d-md-none align-items-center mb-3 bg-white py-2 px-3"
        ...
        <h1 class="header-title text-success">{{ __('Sửa địa chỉ') }}</h1>
    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const selectedWard = @json(old('ward', $address->ward_id));
            const selectedWardName = @json(old('ward_name', $address->ward_name));
            ...
            const loadWard = async (districtId, wardValue = "", wardLabel = "") => {
            ...
            if (citySelect) {
                ...
                if (citySelect.value) {
                    loadWard(citySelect.value, selectedWard, selectedWardName);
                }
            }
        });
    </script>
