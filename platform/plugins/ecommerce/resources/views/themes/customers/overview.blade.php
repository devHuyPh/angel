...
@section('content')
    ...
    <div class="header d-flex d-md-none align-items-center mb-3 bg-white py-2 px-3"
        ...
        <h1 class="header-title text-success">{{ __('Thông tin tài khoản') }}</h1>
    </div>
    @php
    ...
    @endphp
    <div class="container">
        <div class="bb-customer-profile-wrapper pb-2">
            <div class="bb-customer-profile">
                <div class="bb-customer-profile-avatar">
                    ...
                    <div class="bb-customer-profile-avatar-overlay">
                        <input type="file" id="customer-avatar" name="avatar" data-bb-toggle="change-customer-avatar"
                            data-url="{{ route('customer.avatar') }}" />
