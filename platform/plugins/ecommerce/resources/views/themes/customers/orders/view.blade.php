    ...
    <div class="customer-order-detail">
        ...
        <div class="mt-3">
            <div class="d-flex flex-wrap gap-2">
                ...
                @endif
                @if ($order->canBeCanceled())
                    <a class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal-cancel-order" data-toggle="modal" data-target="#modal-cancel-order" hidden>
                        {{ __('Cancel order') }}
                    </a>
                @endif
                @if ($order->canBeReturned())
                    <a class="btn btn-danger" href="{{ route('customer.order_returns.request_view', $order->id) }}" hidden>
                        {{ __('Return Product(s)') }}
                    </a>
                @endif
            </div>
