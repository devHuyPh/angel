...
<head>
    ...
    <link href="{{ asset('vendor/core/core/base/libraries/select2/css/select2.min.css') }}" rel="stylesheet">
...
<body{!! Theme::bodyAttributes() !!}>
    ...
    <script src="{{ asset('vendor/core/core/js-validation/js/order-wehouse.js') }}"></script>
    </body>
