        ...
        $this
            ...
            ->add(
                ...
                TextFieldOption::make()
                    ...
                    ->placeholder(__('Referrer phone number'))
                    ->icon('ti ti-user')
                    ->append('
                        <div class="referral_tooltip" id="referral_tooltip">'
                            . __('Enter the phone number of the introduction') . '
                        </div>
                        <div class="" id="result-phone"></div>
                    </div>')
            )
            ->add(
                'name',
