        ...
        ->when(EcommerceHelper::isProductSpecificationEnabled(), function (DashboardMenuSupport $dashboardMenu): void {
          $dashboardMenu
            ->registerItem([
              ...
              'priority' => 0,
              'name' => 'core/base::layouts.product_specification',
            ...
            ->registerItem([
              ...
              'priority' => 0,
              'name' => 'core/base::layouts.product_specification_groups',
            ...
            ->registerItem([
              ...
              'parent_id' => 'cms-plugins-product-specification',
              'priority' => 10,
              'name' => 'core/base::layouts.product_specification_attributes',
            ...
            ->registerItem([
              ...
              'parent_id' => 'cms-plugins-product-specification',
              'priority' => 20,
              'name' => 'core/base::layouts.product_specification_tables',
    ...
    DashboardMenu::for('customer')->beforeRetrieving(function (): void {
      ...
      ->registerItem([
          ...
          ->registerItem([
      		...
      		// ->registerItem([
      		// 'id' => 'cms-customer-card',
      		// 'priority' => 10,
      		// 'name' => __('plugins/marketplace::marketplace.card'),
      		// 'url' => fn() => route('customer.overview'),
      		...
      		// 'id' => 'card.list_card',
      		// 'priority' => 11,
      		// 'parent_id' => 'cms-customer-card',
      		// 'name' => __('plugins/marketplace::marketplace.list_card'),
      		// 'url' => fn() => route('list_card'),
      		// 'icon' => 'ti ti-layout',
      		// ])
      		// ->registerItem([
      		// 'id' => 'card.my_card',
      		// 'priority' => 12,
      		// 'parent_id' => 'cms-customer-card',
      		// 'name' => __('plugins/marketplace::marketplace.my_card'),
      		// // 'url' => fn() => route('my_cart'),
      		// 'icon' => 'ti ti-credit-card',
      		// ])
          ->registerItem([
              'id' => 'cms-customer-bitsgold',
              'priority' => 20,
              'name' => __('plugins/marketplace::marketplace.my_account'),
              'icon' => 'ti ti-menu',
          ])

          // 👉 Submenu của 'Marketing' (bitsgold)
      ->registerItem([
          'id' => 'bitsgold.dashboard',
          'priority' => 1,
          'parent_id' => 'cms-customer-bitsgold',
          'name' => __('Dashboard'),
          ...
          ->registerItem([
              ...
              'priority' => 4,
              'parent_id' => 'cms-customer-bitsgold',
              'name' => __('plugins/marketplace::marketplace.manager_area'),
