...
'profit_shared_at'
    ...
    public function confirmedShipments()
    {
        return $this->belongsTo(ConfirmVendorShipedToUser::class, 'order_id');
    }

    public function lateDelivery(): HasOne
    {
        return $this->hasOne(VendorLateDelivery::class, 'order_id');
    }
}
