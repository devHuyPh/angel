...
trait ProductPrices
{
    ...
    protected function warehousePricePercent(): Attribute
    {
        return Attribute::get(function (): int {
            if (! $this->warehouse_price || ! $this->price) {
                return 0;
            }

            $percent = ($this->price - $this->warehouse_price) / $this->price * 100;

            return (int) round(max($percent, 0));
        });
    }
