...
class ProductImporter extends Importer implements WithMapping
{
    ...
    public function columns(): array
    {
        $columns = [
            ...
            ImportColumn::make('warehouse_price')
                ->rules(['nullable', 'numeric', 'min:0'], trans('plugins/ecommerce::products.import.rules.nullable_numeric_min', ['attribute' => 'Warehouse price'])),
            ...
            if ($product->variations->count()) {
                foreach ($product->variations as $variation) {
                    ...
                    $data = [
                        ...
                        'warehouse_price' => $variation->product->warehouse_price,
                        'product_attributes' => implode(',', $productAttributes),
    ...
    public function storeVariant(array $row, ?Product $product): ProductVariation|Model|null
    {
        ...
        $productRelatedToVariation->warehouse_price = Arr::get($version, 'warehouse_price', $product->warehouse_price);
    ...
    public function mapLocalization(array $row): array
    {
        ...
        $this->setValues($row, [
            ...
            ['key' => 'warehouse_price', 'type' => 'number'],
