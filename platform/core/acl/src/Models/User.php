    ...
    HasPreferencesContract
{
    ...
    {
        return $this->hasMany(CustomerWithdrawal::class, 'admin_id');
    }
    ...
    public function confirmedShipmentsAsAdmin()
    {
        return $this->hasMany(ConfirmVendorShipedToUser::class, 'admin_id');
    }
}
