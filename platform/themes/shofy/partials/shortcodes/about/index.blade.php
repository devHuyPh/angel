    ...
    <div class="container">
        <div class="row">
                ...
                @if($shortcode->image_1 || $shortcode->image_2)
                    <div class="tp-about-thumb-wrapper p-relative mr-35">
                        ...
                        @if($shortcode->image_2)
                            <div class="tp-about-thumb-2 d-none d-md-block">
            ...
            <div class="col-xl-7 col-lg-6">
                <div class="tp-about-wrapper pl-80 pr-60">
                    <div class="tp-section-title-wrapper-4 mb-50">
                        @if($shortcode->subtitle)
                            <span class="tp-section-title-pre-4">{!! BaseHelper::clean($shortcode->subtitle) !!}</span>
                        @endif
                        @if($shortcode->title)
                            <h3 class="section-title tp-section-title-4 fz-50"; style="color: #228822;">{!! BaseHelper::clean($shortcode->title) !!}</h3>
                        @endif
                    </div>
                    <div class="tp-about-content pl-120">
                        @if($shortcode->description)
                            <p style="color: #228822;">{!! BaseHelper::clean($shortcode->description) !!}</p>
                        @endif

                        @if($shortcode->action_label)
                            <div class="tp-about-btn">
                                <a href="{{ $shortcode->action_url }}" class="tp-btn text-light" style="background-color: #228822; border-color: #4ba213;">
