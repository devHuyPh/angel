...
$(() => {
    ...
    const initSwiper = () => {
        ...
        const $modernCategorySlider = $('.tp-category-modern-slider')

        if ($modernCategorySlider.length) {
            const itemsPerView = $modernCategorySlider.data('items') || 5

            $modernCategorySlider.each(function () {
                const $slider = $(this)
                const $wrapper = $slider.closest('.tp-category-modern-slider-wrapper')
                ...
                new Swiper(this, {
                    ...
                    rtl: isRTL,
                    navigation: {
                        nextEl: $wrapper.find('.tp-category-modern-next')[0],
                        prevEl: $wrapper.find('.tp-category-modern-prev')[0],
                    },
                    pagination: {
                        el: $wrapper.find('.tp-category-modern-pagination')[0],
                        clickable: true,
                    },
                    breakpoints: {
                        1200: {
