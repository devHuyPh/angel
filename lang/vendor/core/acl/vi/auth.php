...
return [
    'login' => [
        ...
        'login' => 'Đăng nhập',
        'placeholder' => [
            'username' => 'Nhập tên người dùng hoặc địa chỉ email của bạn',
            'email' => 'Nhập địa chỉ email của bạn',
            'password' => 'Nhập mật khẩu của bạn',
        ],
        'success' => 'Đăng nhập thành công!',
        'fail' => 'Sai tên người dùng hoặc mật khẩu.',
        'not_active' => 'Tài khoản của bạn chưa được kích hoạt!',
        'banned' => 'Tài khoản này đã bị cấm.',
        'logout_success' => 'Đăng xuất thành công!',
        'dont_have_account' => 'Bạn chưa có tài khoản trên hệ thống này, vui lòng liên hệ quản trị viên để biết thêm thông tin!',
    ],
    'forgot_password' => [
        'title' => 'Quên mật khẩu',
        'message' => '<p>Bạn đã quên mật khẩu?</p><p>Vui lòng nhập tài khoản email của bạn. Hệ thống sẽ gửi một email kèm liên kết kích hoạt để đặt lại mật khẩu của bạn.</p>',
        'submit' => 'Gửi',
    ],
    'reset' => [
        ...
        'update' => 'Cập nhật',
        'wrong_token' => 'Liên kết này không hợp lệ hoặc đã hết hạn. Vui lòng thử lại bằng biểu mẫu đặt lại.',
        'user_not_found' => 'Tên người dùng này không tồn tại.',
        ...
        'send' => [
            'success' => 'Một email đã được gửi đến tài khoản email của bạn. Vui lòng kiểm tra và hoàn tất hành động này.',
    ...
    'lost_your_password' => 'Quên mật khẩu của bạn?',
