...
return [
    ...
    'form' => [
        ...
        'warehouse_price' => 'Warehouse entry price',
        'warehouse_price_placeholder' => 'Enter warehouse entry price',
        'warehouse_price_helper' => 'Warehouse price for internal stock management.',
        'warehouse_price_percent_helper' => 'Discount :percent from original price.',
        'stock' => [
