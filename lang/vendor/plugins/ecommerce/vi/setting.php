...
return [
    ...
    'currency' => [
        ...
        'form' => [
            ...
            'api_key_helper' => 'Nhận khóa API tỷ giá hối đoái trên :link',
    ...
    'product' => [
        ...
        'form' => [
            ...
            'make_product_barcode_required_helper' => 'Nếu được bật, mã vạch sản phẩm sẽ được yêu cầu khi tạo sản phẩm.',
            'make_product_barcode_required' => 'Yêu cầu mã vạch sản phẩm',
            ...
            'enable_product_specification' => 'Cho phép thông số kỹ thuật sản phẩm',
        ],
    ],
    'product_search' => [
        ...
        'form' => [
            ...
            'max_product_price_for_filter_helper' => 'Bạn có thể đặt giá cố định cho mục này hoặc nó sẽ tự động lấy giá sản phẩm tối đa từ các sản phẩm hiện có của bạn. Hiện tại là :price.',
    ...
    'shopping' => [
        ...
        'form' => [
            ...
            'hide_product_price_helper' => 'Tùy chọn này chỉ hoạt động nếu bạn vô hiệu hóa giỏ hàng, biến trang web của bạn thành màn hình chỉ hiển thị danh mục. Nếu được bật, giá sản phẩm sẽ bị ẩn. Nó hữu ích khi bạn muốn ẩn giá và yêu cầu khách hàng liên hệ với bạn để biết giá.',
            'hide_product_price' => 'Ẩn giá sản phẩm',
            'enable_quick_buy_button_helper' => 'Nút Mua ngay sẽ hiển thị trên danh sách sản phẩm và trang chi tiết. Khi khách hàng nhấp vào nút này, sản phẩm sẽ được thêm vào giỏ hàng và chuyển hướng đến trang giỏ hàng/thanh toán.',
            'enable_order_tracking_helper' => 'Khách hàng có thể theo dõi đơn hàng của mình bằng cách nhập mã đơn hàng và email vào :url',
            'cart_destroy_on_logout_helper' => 'Giỏ hàng sẽ bị hủy khi khách hàng đăng xuất.',
            'enable_cart_helper' => 'Nếu tắt, nút giỏ hàng sẽ bị xóa, biến trang web của bạn thành trang web chỉ hiển thị danh mục.',
            'enable_wishlist_helper' => 'Nếu tắt, nút danh sách mong muốn sẽ bị xóa khỏi trang web.',
            'enable_compare_helper' => 'Nếu tắt, nút so sánh sẽ bị xóa khỏi trang web.',
    ...
    'checkout' => [
        ...
        'form' => [
            ...
            'default_country_at_checkout_page_help' => 'Nếu bạn chọn một quốc gia, quốc gia đó sẽ được chọn theo mặc định tại trang thanh toán.',
        ],
    ],
    'return' => [
        'name' => 'Trả lại',
    ...
    'customer' => [
        ...
        'form' => [
            ...
            'enabled_phone_field_in_registration_form' => 'Kích hoạt trường số điện thoại trong biểu mẫu đăng ký',
            'enabled_phone_field_in_registration_form_helper' => 'Khi được kích hoạt, trường số điện thoại sẽ được thêm vào biểu mẫu đăng ký.',
            'make_customer_phone_number_required' => 'Yêu cầu số điện thoại của khách hàng',
            'make_customer_phone_number_required_helper' => 'Khi được kích hoạt, khách hàng phải nhập số điện thoại của họ trong quá trình đăng ký. Số điện thoại luôn bắt buộc đối với khách hàng đăng nhập bằng số điện thoại.',
        ],
    ],
    'shipping' => [
        ...
        'form' => [
            ...
            'sort_shipping_options_direction' => 'Sắp xếp tùy chọn vận chuyển hướng',
            'disable_shipping_options' => 'Vô hiệu hóa tùy chọn vận chuyển',
            'sort_shipping_options_direction_helper' => 'Sắp xếp các tùy chọn vận chuyển theo giá từ thấp đến cao hoặc từ cao đến thấp.',
            'price_lower_to_higher' => 'Giá thấp hơn đến cao hơn',
            'price_higher_to_lower' => 'Giá cao hơn đến thấp hơn',
        ],
    ],
    'webhook' => [
        'name' => 'Webhook',
    ...
    'payment_method_minimum_amount' => 'Số lượng đặt hàng tối thiểu - :currency (Tùy chọn)',
    'display_bank_info_at_the_checkout_success_page' => 'Hiển thị thông tin ngân hàng tại trang thanh toán thành công?',
