...
return [
    'name' => 'Giá sản phẩm',
    'warning_prices' => 'Những mức giá này thể hiện giá gốc của sản phẩm và có thể không phản ánh giá cuối cùng, giá này có thể thay đổi do các yếu tố như khuyến mãi chớp nhoáng, khuyến mãi, v.v.',
    'import' => [
        ...
        'rules' => [
            ...
            'warehouse_price' => 'Trường giá kho phải là giá trị số.',
