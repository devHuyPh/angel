        ...
        'email' => [
            'templates' => [
                ...
                'to_admin' => [
                    ...
                    'newsletter_email' => 'Email của người dùng đăng ký nhận bản tin',
                    'subject' => 'Người dùng mới đã đăng ký nhận bản tin của bạn',
                ],
                'to_user' => [
                    'title' => 'Email gửi tới cho người đăng ký',
                    'description' => 'Mẫu email gửi tới cho người đăng ký',
                    'newsletter_unsubscribe_url' => 'URL để hủy đăng ký nhận bản tin',
                    'newsletter_unsubscribe_link' => 'Liên kết để hủy đăng ký nhận bản tin',
                    'newsletter_email' => 'Email của người dùng đăng ký nhận bản tin',
                    'newsletter_name' => 'Họ tên đầy đủ của người dùng đăng ký nhận bản tin',
                    'subject' => '{{ site_title }}: Đã xác nhận đăng ký!',
                ],
            ],
        ],
        'title' => 'Bản tin',
