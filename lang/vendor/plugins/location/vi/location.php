...
return [
    ...
    'export' => [
        ...
        'total_states' => 'Tổng số huyện',
        'total_cities' => 'Tổng số thành phố',
        'description' => 'Xuất dữ liệu vị trí của bạn như quốc gia, huyện và thành phố.',
    ],
    'import' => [
        ...
        'rules' => [
            ...
            'country' => 'Trường quốc gia là bắt buộc nếu loại nhập là huyện hoặc thành phố.',
