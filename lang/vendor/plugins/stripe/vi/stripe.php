...
return [
    ...
    'webhook_setup_guide' => [
        ...
        'step_1_description' => 'Truy cập :link và nhấp vào nút "Thêm điểm cuối" trong phần "Webhooks" của tab "Nhà phát triển".',
        'step_2_label' => 'Chọn sự kiện và định cấu hình điểm cuối',
        'step_2_description' => 'Chọn sự kiện "payment_intent.succeeded" và nhập URL sau vào trường "URL điểm cuối": :url',
